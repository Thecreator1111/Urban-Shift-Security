...
class ShiftSafetyRequest(BaseModel):
    ...
    ambient_light: float = Field(..., ge=0.0, le=1.0, example=0.1)
    street_light_func: float = Field(..., ge=0.0, le=1.0, example=0.4)
    crime_risk_index: float = Field(..., ge=0.0, le=10.0, example=6.5)
